...
export function MultiSelect<T extends string>({
	...
	return (
		<div className="relative" ref={ref}>
			...
			{open && (
				<div
					className="absolute top-full left-0 z-20 mt-1 min-w-48 rounded border border-border bg-surface shadow-lg shadow-black/40"
					id={panelId}
				>
					{searchable && (
						<div className="p-1.5 border-b border-border">
							<input
								...
								className="w-full rounded border border-border bg-surface-light px-2 py-1 text-sm text-text placeholder:text-text-muted focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/40 transition-colors"
